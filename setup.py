...
def requirements():
	def csv_lib():
		...
		os.system("""
			...
			""")
	banner()
	print(gr+'['+cy+'+'+gr+']'+cy+' it may take up to 10 min to install csv merge.')
	input_csv = input(gr+'['+cy+'+'+gr+']'+cy+' do you want to enable csv merge (y/n): ').lower()
	if input_csv == "y":
		csv_lib()
	else:
		pass
	print(gr+"[+] Installing Required Tools ...")
	os.system("""
...
def update_tool():
	...
	banner()
	source = r.get("https://raw.githubusercontent.com/Samuelodu1/teleg/master/.image/.version")
	if source.text == '3':
		print(gr+'['+cy+'+'+gr+']'+cy+' is already the latest version')
	else:
		print(gr+'['+cy+'+'+gr+']'+cy+' removing old files ...')
		os.system('rm *.py');time.sleep(3)
		print(gr+'['+cy+'+'+gr+']'+cy+' getting latest files ...')
		os.system("""
			curl -s -O https://raw.githubusercontent.com/Samuelodu1/teleg/master/add.py
			curl -s -O https://raw.githubusercontent.com/Samuelodu1/teleg/master/extract.py
			curl -s -O https://raw.githubusercontent.com/Samuelodu1/teleg/master/setup.py
			curl -s -O https://raw.githubusercontent.com/Samuelodu1/teleg/master/smsbot.py
			chmod 777 *.py
			""");time.sleep(3)
...
try:
	...
	print(gr+'['+re+'!'+gr+']'+cy+' for help use : ')
	print(gr+'['+re+'!'+gr+']'+cy+' https://raw.githubusercontent.com/Samuelodu1/teleg#-how-to-install-and-use')
	print(gr+'$ python3 setup.py -h'+'\n')
